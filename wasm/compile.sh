...
echo "compiling..."
$EMPATH/emcc ../glue_wrapper.cpp --post-js glue.js  -std=c++11  -s SINGLE_FILE=1 -s EXPORT_NAME="_TRACESKELETON" --closure 1 -s MODULARIZE=1 -s ALLOW_MEMORY_GROWTH=1 -s WASM=1 -O3 -o trace_skeleton.js
